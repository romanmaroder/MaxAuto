                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown messages-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="label label-success"><?= $mails ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="header" style="text-align: center">У Вас <?php echo $mails; if ($mails >= 2 || empty($mails) ) {echo ' сообщений'; }else {echo ' сообщение';}?> </li>
